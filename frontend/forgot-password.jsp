...
<head>
    ...
    <title>Reset Password - VehicleCare</title>
...
<body>
    ...
    <div class="glass-container" style="max-width: 500px; margin: 60px auto;">
        <h2 style="text-align: center; color: var(--primary); margin-bottom: 25px;">
            <i class="fas fa-user-shield"></i> Account Password Reset
        </h2>
        ...
        <form action="AuthController" method="POST">
            ...
            <div class="form-group">
                <label for="email"><i class="fas fa-envelope"></i> Account Email</label>
            ...
            <div class="form-group">
                ...
                <input type="password" name="newPassword" id="password" class="form-control" placeholder="••••••••" required>
            ...
            <button type="submit" class="btn-ripple" style="width: 100%; border-radius: 8px;"><i class="fas fa-key"></i> Update Password</button>
        </form>
